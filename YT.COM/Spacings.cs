...
namespace YT.COM
{
    public class Spacings
    {
        ...
        public ArrayList LeftSpacing(TSG.Point ls, TSG.Point le, TSG.Point rs, TSG.Point re, double length, double spac, string size)
        {
        ...
        public ArrayList RightSpacing(TSG.Point ls, TSG.Point le, TSG.Point rs, TSG.Point re, double length, double spac, string size)
        {
            var list = new ArrayList();
