...
namespace YT.WallVerticalRebar.DM
{
    ...
    /// </summary>
    public class PluginManipulationContext : ManipulationContext
    {
        /// <summary>
        /// The handle manager.
        /// </summary>
        ...
        public PluginManipulationContext(Component component, PluginManipulationFeatureBase feature) : base(component, feature)
        {
